<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin8.aspx.cs" Inherits="Climber.Admin8" %>
                ...
                <td align="left" valign="top">
                    <asp:Panel ID="Panel1" BackColor="#EAF1FB" BorderColor="#07519A" runat="server" BorderWidth="1px"
                        ...
                        <asp:Button ID="Button2" Text="部门信息" BorderStyle="None" runat="server" Width="200px"
                            ...
                            CausesValidation="False" OnClick="Button1_Click" Font-Bold="True" TabIndex="7" />
                        ...
                        <asp:Button ID="Button7" Text="密码重置" BorderStyle="None" runat="server" Width="200px"
                            Height="40px" BackColor="#EAF1FB" Font-Names="黑体" Font-Size="Medium" ForeColor="#07519A"
                            CausesValidation="False" OnClick="Button1_Click" TabIndex="12" />
                    ...
                    <table align="center" width="700px">
                        ...
                        <tr>
                            <td>
                                <br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
                                <asp:Label ID="TitleName" Font-Size="X-Large" runat="server" Text="部门信息" ForeColor="#07519A"
                                ...
                                <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                    <asp:View ID="View1" runat="server">
                                        <table align="center" width="650px" style="border: 0.1px dashed #C49760; font-size: small;
                                            ...
                                            <tr>
                                                <td bgcolor="#EEEEEE" style="height: 24px" height="24px">
                                                    部门名称
                                                </td>
                                                <td bgcolor="#EEEEEE" style="height: 24px" height="24px">
                                                    <asp:TextBox ID="bumen" runat="server" Height="12px" Width="100px" TabIndex="1"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RFVbumen" runat="server" ControlToValidate="bumen"
                                                        ErrorMessage="不能为空" Font-Size="X-Small" ForeColor="Red"></asp:RequiredFieldValidator>
                                                </td>
                                                <td bgcolor="#EEEEEE" height="24px" width="60">
                                                    部长
                                                </td>
                                                <td bgcolor="#EEEEEE" height="24px" width="120">
                                                    <asp:TextBox ID="buzhang" runat="server" Height="12px" Width="80px" TabIndex="2"></asp:TextBox>
                                                </td>
                                                <td bgcolor="#EEEEEE" height="24px" width="60">
                                                    副部长
                                                </td>
                                                <td bgcolor="#EEEEEE" height="24px" width="120">
                                                    <asp:TextBox ID="fubuzhang" runat="server" Height="12px" Width="80px" TabIndex="3"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#EEEEEE" colspan="6" style="text-align: center" height="24px">
                                                    <asp:Button ID="charu" Text="插入" runat="server" OnClick="charu_Click" TabIndex="4" />
                                                    <asp:Button ID="chongzhi" Text="重置" runat="server" OnClick="chongzhi_Click" CausesValidation="False"
                                                        TabIndex="5" />
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <td align="center">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" HorizontalAlign="Center"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="部门名称" HeaderText="部门名称"></asp:BoundField>
                                        <asp:BoundField DataField="部长" HeaderText="部长"></asp:BoundField>
                                        <asp:BoundField DataField="副部长" HeaderText="副部长"></asp:BoundField>
